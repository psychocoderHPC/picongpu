...
namespace picongpu
{
namespace currentSolverZigZagNative
{
 ...
 */
template<uint32_t T_Dim,typename T_ParticleShape>
struct GetMargin<picongpu::currentSolverZigZagNative::ZigZagNative<T_Dim, T_ParticleShape> >
{
private:
    typedef picongpu::currentSolverZigZagNative::ZigZagNative<T_Dim, T_ParticleShape> Solver;
public:
