...
struct GetMargin<picongpu::currentSolverEsirkepov::Esirkepov<DIM3,ParticleShape, NumericalCellType> >
{
private:
    typedef picongpu::currentSolverEsirkepov::Esirkepov<DIM3,ParticleShape, NumericalCellType> Solver;
public:
