...
private:
    ...
    {        
        typedef SuperCellDescription<
                SuperCellSize,
                typename toTVec<typename CurlB::LowerMargin>::type,
                typename toTVec<typename CurlB::UpperMargin>::type
                > BlockArea;
    ...
    void updateBHalf()
    {
        typedef SuperCellDescription<
                SuperCellSize,
                typename toTVec<typename CurlE::LowerMargin>::type,
                typename toTVec<typename CurlE::UpperMargin>::type
                > BlockArea;
