...
public:
    ...
    MySimulation() : laser(NULL), fieldB(NULL), fieldE(NULL), fieldJ(NULL), fieldTmp(NULL), cellDescription(NULL), initialiserController(NULL), slidingWindow(false)
    {
        ...
        ForEach<VectorAllSpecies, particles::AssignNull<void>, Cover<void>  > setPtrToNull;
    ...
    virtual void pluginUnload()
    {
        ...
        ForEach<VectorAllSpecies, particles::CallDelete<void> , Cover<void> > deleteParticleMemory;
    ...
    virtual uint32_t init()
    {
        ...
        ForEach<VectorAllSpecies, particles::CreateSpecies<void>, Cover<void> > createSpeciesMemory;
        ...
        ForEach<VectorAllSpecies, particles::CallCreateParticleBuffer<void>, Cover<void> > createParticleBuffer;
        ...
        ForEach<VectorAllSpecies, particles::CallInit<void>, Cover<void> > particleInit;
    ...
    virtual void runOneStep(uint32_t currentStep)
    {
        ...
        ForEach<VectorAllSpecies, particles::CallUpdate<void>, Cover<void> > particleUpdate;
...
#if (ENABLE_CURRENT ==1)
        ForEach<VectorAllSpecies, ComputeCurrent<void,boost::mpl::int_<CORE + BORDER> >, Cover<void> > computeCurrent;
    ...
    void resetAll(uint32_t currentStep)
    {
        ...
        ForEach<VectorAllSpecies, particles::CallReset<void>, Cover<void> > callReset;
        callReset(byRef(particleStorage), currentStep);
    }
