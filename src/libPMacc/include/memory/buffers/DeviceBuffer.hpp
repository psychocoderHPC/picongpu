...
class DeviceBuffer : public Buffer<T_BufferDef>
{
protected:
    ...
    typedef DeviceBuffer<BufferDef> This;
...
public:
    ...
    using Base::setCurrentSize; //!\todo :this function was hidden, I don't know why.
...
#undef COMMA
     ...
     */
    virtual void copyFrom(HostBuffer<BufferDef>& other) = 0;
     ...
     */
    virtual void copyFrom(This& other) = 0;
