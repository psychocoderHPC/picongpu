...
class DeviceBufferIntern : public DeviceBuffer<T_BufferDef>
{
public:
    ...
    typedef DeviceBufferIntern<BufferDef> This;
    typedef DeviceBuffer<BufferDef> Base;
    ...
    DeviceBufferIntern(DeviceBuffer<BufferDef>& source, DataSpace<DIM> dataSpace, DataSpace<DIM> offset, bool sizeOnDevice = false) :
    Base(dataSpace),
    sizeOnDevice(sizeOnDevice),
    ...
    void copyFrom(HostBuffer<BufferDef>& other)
    {
