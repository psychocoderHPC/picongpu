...
PseudoBuffer<Type, dim>::PseudoBuffer(PMacc::DeviceBuffer< BufferDefinition<_Type, dim> >& devBuffer)
{
...
template<typename Type, int dim>
template<typename _Type>
PseudoBuffer<Type, dim>::PseudoBuffer(PMacc::HostBuffer< BufferDefinition<_Type, dim> >& hostBuffer)
{
