...
namespace alpaka
{
    ...
    namespace trait
    {
        ...
        template<typename T_Type, uint32_t T_dim, typename T_Navigator, typename T_Storage>
        struct GetExtents<pmacc::math::Vector<T_Type, T_dim, T_Navigator, T_Storage>>
        {
            ALPAKA_FN_HOST_ACC
        ...
        template<typename T_Type, uint32_t T_dim, typename T_Navigator, typename T_Storage>
        struct GetOffsets<pmacc::math::Vector<T_Type, T_dim, T_Navigator, T_Storage>>
        {
            ALPAKA_FN_HOST_ACC
        ...
        template<typename T_Type, uint32_t T_dim, typename T_Navigator, typename T_Storage>
        struct IdxType<pmacc::math::Vector<T_Type, T_dim, T_Navigator, T_Storage>>
        {
            using type = IdxType;
        };
