        ...
        namespace rng
        {
            namespace distributions
            {
                namespace detail
                {
                    ...
                    private:
                        using Dist = decltype(::alpaka::rand::distribution::createUniformReal<Type>(
                    ...
                    public:
                        ...
                        HDINLINE Uniform_float(const T_Acc& acc)
                            : dist(::alpaka::rand::distribution::createUniformReal<Type>(acc))
                        {
                        }
                ...
                {
                    template<typename T_Acc>
                    static HDINLINE detail::Uniform_float<T_Acc> get(T_Acc const& acc)
                    {
