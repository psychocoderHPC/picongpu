            ...
            namespace detail
            {
                    ...
                    float_X const beta_0) const
                {
                    if(auto_tdelay)
                    {
                        ...
                        float_64 const y2 = m * (pulselength_SI * picongpu::setup(unit::si_).physicalConstant.speed_of_light) / math::cos(eta);
                        ...
                        float_64 const tdelay = (y1 + y2 + y3) / (picongpu::setup(unit::si_).physicalConstant.speed_of_light * beta_0);
