...
namespace currentSolver
{
    ...
    >
    {
        ...
        {
            this->charge = charge;
            const float2_X deltaPos = float2_X(velocity.x() * deltaTime / cellSize(base::PIC).x(),
        ...
        )
        {
            ...
            const float_X currentSurfaceDensityZ = this->charge * ( float_X( 1.0 ) / float_X( CELL_VOLUME(base::PIC) ) ) * v_z;
