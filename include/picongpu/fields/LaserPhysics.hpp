...
namespace fields
{
    ...
    struct LaserPhysics
    {
        void operator()(uint32_t currentStep) const
        {
             ...
             */
            const float_X laserTimeShift = laserProfiles::Selected::Unitless::initPlaneY * CELL_HEIGHT(base::PIC) / SPEED_OF_LIGHT;
            ...
            bool const laserInitTimeOver =
                ( ( currentStep * DELTA_T(base::PIC)  - laserTimeShift ) >= laserProfiles::Selected::Unitless{}.INIT_TIME );
