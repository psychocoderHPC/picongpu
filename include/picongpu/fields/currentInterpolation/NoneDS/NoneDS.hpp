    ...
    namespace currentInterpolation
    {
        namespace detail
        {
            ...
            struct LinearInterpolateComponentPlaneUpper
            {
                ...
                using UpperMargin = typename pmacc::math::CT::make_Int<dim, 1>::type;
            ...
            struct ShiftCurl : T_Curl
            {
                ...
                {
                    ShiftMeIfYouCan<simDim, 0> const sx;
                    ShiftMeIfYouCan<simDim, 1> const sy;
                    ShiftMeIfYouCan<simDim, 2> const sz;
        ...
        struct NoneDS
        {
            ...
            HDINLINE void operator()(T_DataBoxE fieldE, T_DataBoxB fieldB, T_DataBoxJ const fieldJ)
            {
                ...
                detail::LinearInterpolateComponentPlaneUpper<dim, 0> const avgX;
                ComponentJ const jXavg = avgX(fieldJ);
                detail::LinearInterpolateComponentPlaneUpper<dim, 1> const avgY;
                ComponentJ const jYavg = avgY(fieldJ);
                detail::LinearInterpolateComponentPlaneUpper<dim, 2> const avgZ;
                ComponentJ const jZavg = avgZ(fieldJ);

                TypeJ const jAvgE = TypeJ(jXavg, jYavg, jZavg);
