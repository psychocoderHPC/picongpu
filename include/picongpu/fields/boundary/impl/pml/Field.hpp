...
namespace picongpu
{
    namespace fields::boundary::impl::pml
    {
        ...
        public:
             ...
             */
            OuterLayerBox(GridLayout<simDim> const& gridLayout, impl::Thickness const& globalThickness, DataBox box);
        ...
        public:
             ...
             * @param globalThickness global PML thickness
             */
            HINLINE Field(MappingDesc const& cellDescription, impl::Thickness const& globalThickness);
        ...
        private:
            ...
            impl::Thickness globalThickness;
        };
        ...
        public:
             ...
             * @param globalThickness global PML thickness
             */
            HINLINE FieldE(MappingDesc const& cellDescription, impl::Thickness const& globalThickness)
            ...
            {
                return UnitValueType::create(setup(unit::si_).unit.efield);
            }
        ...
        public:
             ...
             * @param globalThickness global PML thickness
             */
            HINLINE FieldB(MappingDesc const& cellDescription, impl::Thickness const& globalThickness)
                : Field(cellDescription, globalThickness)
            {
            }
            ...
            HDINLINE static UnitValueType getUnit()
            {
                return UnitValueType::create(setup(unit::si_).unit.bfield);
            }
    ...
    namespace traits
    {
        ...
        struct FieldPosition<fields::cellType::Yee, fields::boundary::impl::pml::FieldE, T_dim>
         ...
         */
        template<uint32_t T_dim>
        struct FieldPosition<fields::cellType::Yee, fields::boundary::impl::pml::FieldB, T_dim>
         ...
         */
        template<>
        struct IsFieldDomainBound<fields::boundary::impl::pml::FieldE> : std::false_type
        {
        };
         ...
         */
        template<>
        struct IsFieldDomainBound<fields::boundary::impl::pml::FieldB> : std::false_type
        {
        };
         ...
         */
        template<>
        struct IsFieldOutputOptional<fields::boundary::impl::pml::FieldE> : std::true_type
        {
        };
         ...
         */
        template<>
        struct IsFieldOutputOptional<fields::boundary::impl::pml::FieldB> : std::true_type
        {
        };
    } // namespace traits
} // namespace picongpu
namespace pmacc
{
    namespace traits
    {
        ...
        template<>
        struct GetComponentsType<picongpu::fields::boundary::impl::pml::NodeValues, false>
        {
        ...
        //! Node value traits for checkpointing
        template<>
        struct GetNComponents<picongpu::fields::boundary::impl::pml::NodeValues, false>
        {
            static constexpr uint32_t value = picongpu::fields::boundary::impl::pml::NodeValues::numComponents;
        };
...
#include "picongpu/fields/boundary/impl/pml/Field.tpp"