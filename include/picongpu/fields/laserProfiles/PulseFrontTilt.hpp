...
namespace acc
{
    ...
    struct PulseFrontTilt : public T_Unitless
    {
        ...
        )
        {
            ...
            float_X const spaceShift_x = SPEED_OF_LIGHT * cupla::math::tan( local_tilt_x ) * timeShift / cellSize.y();
            ...
            float_X const w_y = Unitless::W0 * cupla::math::sqrt( 1.0_X + ( focusPos / y_R )*( focusPos / y_R ) );
            //! the Gouy phase shift
            float_X const xi_y = cupla::math::atan( -focusPos / y_R );
