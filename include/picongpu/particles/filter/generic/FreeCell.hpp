...
#include "picongpu/particles/filter/generic/FreeCell.def"
...
namespace generic
{
    ...
    struct FreeCell : public functor::generic::FreeCell< T_Functor >
    {
        using Base = functor::generic::FreeCell< T_Functor >;
         ...
         */
        HINLINE FreeCell( uint32_t currentStep ) : Base( currentStep )
        {
        }
    };
