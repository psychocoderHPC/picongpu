    ...
    private:
        ...
        HDINLINE static detail::LorentzBoost getLorentzBoostFromIonToLab(T_IonParticle& ion)
        {
            ...
            if(isParMoving)
            {
                ...
                directionVector = static_cast<float3_64>(momentumLab / math::sqrt(momentumSquared) / weighting);
