        ...
        namespace externalBeam
        {
            namespace startPosition
            {
                namespace acc
                {
                    ...
                    public:
                        HINLINE RandomProbingBeamImpl() : axisSwap(SideCfg::getAxisSwap())
                        {
                        }
                ...
                struct RandomProbingBeamImpl
                {
                    HINLINE explicit RandomProbingBeamImpl(uint32_t const& currentStep)
                    {
                    }
                    ...
                    HDINLINE auto operator()(T_Worker const& worker, DataSpace<simDim> const& localSupercellOffset)
                        const
                    {
                        return acc::RandomProbingBeamImpl<T_ParamClass>();
                    }
                };
            } // namespace startPosition
        } // namespace externalBeam
