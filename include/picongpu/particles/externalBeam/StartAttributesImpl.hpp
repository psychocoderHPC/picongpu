    ...
    namespace particles
    {
        namespace externalBeam
        {
...

            {
                ...
                HINLINE explicit StartAttributesImpl(uint32_t const& currentStep)
...

            {
                ...
                {
                    using type
                        = StartAttributesImpl<T_Species, T_StartPositionFunctor, T_MomentumFunctor, T_Functor...>;
                };
            };
        } // namespace externalBeam
    } // namespace particles
