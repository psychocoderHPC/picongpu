            ...
            namespace beam
            {
                ...
                public:
                        ...
                        bool const& swapOnly = false) const
                    {
                        ...
                        DataSpace<DIM3> result;
                        result[0]
                            = a[0] >= 0 ? cellIdx3d[axis[0]] : (globalDomainSize[axis[0]] - 1) - cellIdx3d[axis[0]];
                        result[1]
                            = a[1] >= 0 ? cellIdx3d[axis[1]] : (globalDomainSize[axis[1]] - 1) - cellIdx3d[axis[1]];
                        result[2]
                            = a[2] >= 0 ? cellIdx3d[axis[2]] : (globalDomainSize[axis[2]] - 1) - cellIdx3d[axis[2]];
                        return result;
                    }
                };
            } // namespace beam
