        ...
        struct Push
        {
                ...
                const uint32_t)
            {
                ...
                */
                ...
                // mom /(mass*mass + abs2(mom)/(setup().physicalConstant.speed_of_light*setup().physicalConstant.speed_of_light));
                ...
                const sqrt_Vay::float_X u_star
                    ...
                    / precisionCast<sqrt_Vay::float_X>(setup().physicalConstant.speed_of_light * mass);
