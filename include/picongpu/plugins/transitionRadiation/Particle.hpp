    ...
    namespace plugins
    {
        namespace transitionRadiation
        {
            ...
            public:
                ...
                {
                    return betaAbs * picongpu::setup().physicalConstant.speed_of_light;
                }
            ...
            private:
                ...
                {
                    return momentum * (1.0 / (mass * picongpu::setup().physicalConstant.speed_of_light * gamma));
                }
                ...
                {
                    float_X const massTimesC = mass * picongpu::setup().physicalConstant.speed_of_light;
                    return picongpu::math::sqrt(
