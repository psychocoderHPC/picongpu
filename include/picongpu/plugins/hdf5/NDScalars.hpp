    ...
    namespace hdf5
    {
                ...
                T_Attribute attribute = T_Attribute())
            {
                ...
                if(!attrName.empty())
                {
                    ...
                    params.dataCollector
                        ->writeAttribute(params.currentStep, attType, name.c_str(), attrName.c_str(), &attribute);
                }
            }
        };
        ...
        struct ReadNDScalars
        {
                ...
                T_Attribute* attribute = nullptr)
            {
                ...
                DataContainer* dataContainer = params.dataCollector->readDomain(
                    params.currentStep,
                    name.c_str(),
                ...
                *value = *static_cast<T_Scalar*>(dataContainer->getIndex(0)->getData());
                ...
                if(!attrName.empty())
                {
                    ...
                    params.dataCollector->readAttributeInfo(params.currentStep, name.c_str(), attrName.c_str())
                        .read(attribute, sizeof(T_Attribute));
