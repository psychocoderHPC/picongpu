    ...
    namespace hdf5
    {
        ...
        public:
            ...
            HINLINE void operator()(ThreadParams* params, const uint32_t restartChunkSize)
            {
                ...
                const std::string speciesSubGroup(std::string("particles/") + speciesName + std::string("/"));
                ...
                const std::string particlePatchesPath(speciesSubGroup + std::string("particlePatches/"));
                ...
                picongpu::openPMD::ParticlePatches particlePatches(patchReader(
                 ...
                 *      as its counterpart
                 */
                const DataSpace<simDim> patchOffset = globalDomain.offset + params->window.globalDimensions.offset
                    + params->window.localDimensions.offset;
                const DataSpace<simDim> patchExtent = params->window.localDimensions.size;
                ...
                meta::ForEach<typename Hdf5FrameType::ValueTypeSeq, LoadParticleAttributesFromHDF5<bmpl::_1>>
                    loadAttributes;
