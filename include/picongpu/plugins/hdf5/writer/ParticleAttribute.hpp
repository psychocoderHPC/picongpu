        ...
        struct ParticleAttribute
        {
                ...
                const uint64_t numParticlesGlobal)
            {
                ...
                for(uint32_t d = 0; d < simDim; ++d)
                {
                    ...
                    splashGlobalDomainOffset[d]
                        = threadParams->window.globalDimensions.offset[d] + globalSlideOffset[d];
...
#pragma omp parallel for
                    ...
                    threadParams->dataCollector->writeDomain(
                        ...
                        splash::Domain(splashGlobalDomainOffset, splashGlobalDomainSize),
                ...
                log<picLog::INPUT_OUTPUT>("HDF5:  ( end ) write species attribute: %1%") % Identifier::getName();
            }
        };
