...
namespace writeMeta
{
    ...
    struct WriteMeta
    {
        ...
        void operator()(ThreadParams *threadParams)
        {
            ...
            dc->writeAttribute( currentStep, splashFloatXType, nullptr, "dt", &DELTA_T(base::PIC) );
            const float_X time = float_X( threadParams->currentStep ) * DELTA_T(base::PIC);
            ...
            dc->writeAttribute( currentStep, splashFloatXType, nullptr, "cell_width", &CELL_WIDTH(base::PIC) );
            dc->writeAttribute( currentStep, splashFloatXType, nullptr, "cell_height", &CELL_HEIGHT(base::PIC) );
            if( simDim == DIM3 )
            {
