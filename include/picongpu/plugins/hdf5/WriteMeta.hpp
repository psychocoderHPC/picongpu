    ...
    namespace hdf5
    {
        ...
        namespace writeMeta
        {
            ...
            struct OfAllSpecies
            {
                 ...
                 */
                void operator()(ParallelDomainCollector* dc, const std::string& meshesPath, const uint32_t currentStep)
                    const
                {
                    ...
                    dc->writeAttribute(
                        ...
                        "particleBoundary",
                        1u,
                        Dimensions(listParticleBoundary.size(), 0, 0),
                        &(arrParticleBoundary.buffers.at(0)));
                    dc->writeAttribute(
                        currentStep,
                        ctParticleBoundaryParam,
                        meshesPath.c_str(),
                        "particleBoundaryParameters",
                        1u,
                        Dimensions(listParticleBoundaryParam.size(), 0, 0),
        ...
        struct WriteMeta
        {
            ...
            void operator()(ThreadParams* threadParams)
            {
                ...
                dc->writeGlobalAttribute(threadParams->currentStep, ctUInt32, "openPMDextension", &openPMDextension);

                const std::string basePath("/data/%T/");
                ColTypeString ctBasePath(basePath.length());
                dc->writeGlobalAttribute(threadParams->currentStep, ctBasePath, "basePath", basePath.c_str());

                const std::string meshesPath("fields/");
                ColTypeString ctMeshesPath(meshesPath.length());
                dc->writeGlobalAttribute(threadParams->currentStep, ctMeshesPath, "meshesPath", meshesPath.c_str());
                ...
                if(author.length() > 0)
                {
                    ...
                    dc->writeGlobalAttribute(threadParams->currentStep, ctAuthor, "author", author.c_str());
                }
                const std::string software("PIConGPU");
                ColTypeString ctSoftware(software.length());
                dc->writeGlobalAttribute(threadParams->currentStep, ctSoftware, "software", software.c_str());
                ...
                dc->writeGlobalAttribute(threadParams->currentStep, ctDate, "date", date.c_str());
                /*   ED-PIC */
                ...
                dc->writeAttribute(currentStep, ctFieldSolver, meshesPath.c_str(), "fieldSolver", fieldSolver.c_str());
                ...
                dc->writeAttribute(
                    ...
                    "fieldBoundary",
                    1u,
                    Dimensions(listFieldBoundary.size(), 0, 0),
                    &(arrFieldBoundary.buffers.at(0)));
                dc->writeAttribute(
                    currentStep,
                    ctFieldBoundariesParam,
                    meshesPath.c_str(),
                    "fieldBoundaryParameters",
                    1u,
                    Dimensions(listFieldBoundaryParam.size(), 0, 0),
                ...
                if(currentSmoothingProp.find("param") != currentSmoothingProp.end())
                {
                    ...
                    dc->writeAttribute(
                        currentStep,
                        ctCurrentSmoothingParam,
                        meshesPath.c_str(),
                        "currentSmoothingParameters",
                        currentSmoothingParam.c_str());
                }
