    ...
    namespace openPMD
    {
        ...
        void ParticlePatches::print()
        {
            std::cout << "id | numParticles numParticlesOffset "
                      << "offsetX offsetY offsetZ extentX extentY extentZ" << std::endl;
            for(size_t i = 0; i < this->size(); ++i)
            {
                std::cout << i << " | " << numParticles.at(i) << " " << numParticlesOffset.at(i) << " "
                          << offsetX.at(i) << " " << offsetY.at(i) << " " << offsetZ.at(i) << " " << extentX.at(i)
                          << " " << extentY.at(i) << " " << extentZ.at(i) << std::endl;
            }
        }
